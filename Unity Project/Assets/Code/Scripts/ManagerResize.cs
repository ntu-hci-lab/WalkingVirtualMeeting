...
public class ManagerResize : MonoBehaviour
{
    //[SerializeField] private RectTransform canvasRectTransform;
    public GameObject target;
    [SerializeField] private GameObject leftHand;
    [SerializeField] private GameObject rightHand;
    [SerializeField] private float CDGain;
    ...
    {
        float scale = Mathf.Max(minScale, sizeDeltaChange.x);
        //Debug.Log(sizeDeltaChange);
        //Debug.Log(target.sizeDelta);
        //Debug.Log("##############");
        target.transform.localScale = new Vector3(Mathf.Max(minScale, target.transform.localScale.x + sizeDeltaChange.x * CDGain), Mathf.Max(minScale, target.transform.localScale.y + sizeDeltaChange.x * CDGain), target.transform.localScale.z);
